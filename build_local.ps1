...
& Rscript -e "install.packages('rmarkdown', repos='http://cran.case.edu/')"
& Rscript -e "install.packages('bookdown', repos='http://cran.case.edu/')"
& Rscript -e "install.packages('reticulate', repos='http://cran.case.edu/')"
 
& Rscript -e "bookdown::render_book('01_chapter.rmd', 'bookdown::gitbook')"
